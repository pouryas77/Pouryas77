...
- **Python** — Expert  
  (Data Science, Scientific Computing, Automation, Scripting, and various applications)
- **MATLAB** — Expert  
  (Simulation, Modeling, Signal Processing, Optimization)
...
- Photonics Simulation (Lumerical, Zemax, etc.)
- LaTeX, Jupyter Notebook, Git
